...
import { Grapics2DEntity, EntityType } from './graphics-2d-entity';
import { LineSegment } from './line-segment';
import { Point } from './point';
import { Vector } from './vector';

export class Circle extends Grapics2DEntity {
  clone(): Grapics2DEntity {
  ...
  intersectWithLineSegement(line: LineSegment) {
  ...
  intersectWithCircle(otherCircle: Circle) {
    ...
    const { points } = this.intersectWithLineSegement(secantLine);
    return points;
  }
