// import { Group, LineSegment, Point } from '@grapics2d/entities';
// import { renderSvg, Svg } from '../lib';

// describe('group to svg', () => {
//   it('creates a svg with child elements', () => {
...
//       new Point(25, 25),
//     ]);
//     const s = renderSvg(Svg({ entity: group }));
//     console.log(s);
